import { isInt, Mode, assert, assertInt, assertFuncIn, assertData } from "../Util";
...
export const COMPILE: Loadable = (ma: Machine): boolean => {
    ...
    const initCOMPILE: Func = function(m: Machine): void {
        ...
        m.overwrite(d.getWordAddress("P_:") as number,
    ...
    const parseCOMPILE: Func = function(m: Machine): void {
        ...
        if (m.compile_definition == null) {
            throw new Error("Compile_definition is empty while parsing compile definition");
        }
